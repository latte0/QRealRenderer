...
void FBXLoader::GetBoneMatrix(float frame, int meshId, Matrix4f* out_matrixList, int matrixCount, HandInfo* handInfo)
{
  auto& modelMesh = this->meshList[meshId];
...
Eigen::Matrix4f FBXLoader::CalculateLocalBoneMatrix(std::string boneNodeName, HandInfo* handInfo){
