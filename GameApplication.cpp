...
GameApplication::GameApplication(QWidget *parent)
...
unsigned char* GameApplication::make_dummy_texture (int* width_, int* height_)
{
    int height = 256;
    int width  = 256;
...
void GameApplication::DrawAxisAlignedQuad(float afLowerLeftX, float afLowerLeftY, float afUpperRightX, float afUpperRightY)
{
...
void GameApplication::DistortQuad(QOpenGLFramebufferObject *src, QOpenGLFramebufferObject *src2, QOpenGLFramebufferObject *dest)
{
       // dest->bind();
...
void GameApplication::processing()
{
    update();
}

void GameApplication::initializeGL ()
{
    //
...
void GameApplication::initOVR(){

}

void GameApplication::initFB(){
...
void GameApplication::updateuniform(){
...
void GameApplication::CalculateHmdValues()
{

}

void GameApplication::getOculusAngle(){
    ovrTrackingState state = ovrHmd_GetTrackingState(Hmd, 0);
...
void GameApplication::genVideoTexture()
{
...
GLuint GameApplication::loadTexture (const std::string & filename)
{
...
void GameApplication::mouseMoveEvent(QMouseEvent *e)
{
